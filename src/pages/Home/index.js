...
function Home() {
    ...
    return (_jsxs(Container, { children: [_jsx(ContainerInputs, { children: Listas.map((lista) => _jsx(InputSelect, { label: lista.titulo, valores: lista.var, value: lista.value, handleChange: lista.onChange }, lista.titulo)) }), _jsxs(ContainerTextArea, { children: [_jsx(InputTexto, { name: 'lembrete', label: 'Lembrete', value: lembrete, onChange: e => setLembrete(e.target.value) }, 'lembrete'), _jsx(InputTexto, { name: 'foto', label: 'Foto', value: foto, onChange: e => setFoto(e.target.value) }, 'foto'), _jsx(InputTexto, { name: 'lendo', label: 'Lendo', value: lendo, onChange: e => setLendo(e.target.value) }, 'lendo'), _jsx(InputTextArea, { value: textArea, onChange: (e) => setTextArea(e.target.value) }), _jsx(Botao, { onClick: handleClick })] }), _jsx(Tabela, { rows: rows })] }));
}
export default Home;
